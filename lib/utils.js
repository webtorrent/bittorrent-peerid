export function isAzStyle (peerId) {
 ...
 */
export function isShadowStyle (peerId) {
...
export function isMainlineStyle (peerId) {
  /**
...
export function isPossibleSpoofClient (peerId) {
  return peerId.endsWith('UDP0') || peerId.endsWith('HTTPBT')
}

export function getAzStyleVersionNumber (peerId, version) {
...
export function getShadowStyleVersionNumber (peerId) {
  // TODO
  return null
}

export function decodeBitSpiritClient (peerId, buffer) {
...
export function decodeBitCometClient (peerId, buffer) {
  let modName = ''
...
export function identifyAwkwardClient (peerId, buffer) {
...
export function decodeNumericValueOfByte (b, minDigits = 0) {
  let result = `${b & 0xff}`
